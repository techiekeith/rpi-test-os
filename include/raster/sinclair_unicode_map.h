...
static int zx_basic_latin[0x60] = {
        ...
        0x050, 0x051, 0x052, 0x053, 0x054, 0x055, 0x056, 0x057, 0x058, 0x059, 0x05a, 0x05b, 0x05c, 0x05d, 0x05e, 0x000
};

/*
 * Latin-1 Supplement (U+00A0-00FF)
 */
static int zx_latin1_supplement[0x60] = {
        0x000, 0x000, 0x000, 0x040, 0x000, 0x000, 0x000, 0x000, 0x000, 0x05f, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000,
        0x000, 0x000, 0x000, 0x000, 0x007, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000,
...
static int zx_general_punctuation[0x18] = {
        0x000, 0x000, 0x000, 0x000, 0x07b, 0x000, 0x000, 0x000, 0x077, 0x007, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000,
...
static int zx_block_elements[32] = {
        0x062, 0x000, 0x000, 0x000, 0x06b, 0x000, 0x000, 0x000, 0x06e, 0x000, 0x000, 0x000, 0x069, 0x000, 0x000, 0x000,
        0x064, 0x000, 0x06f, 0x000, 0x000, 0x000, 0x067, 0x063, 0x061, 0x06d, 0x065, 0x06a, 0x066, 0x060, 0x068, 0x06c
};
...
unicode_block_idx_t sinclair_unicode_block_index[SINCLAIR_UNICODE_BLOCKS] = {
        ...
        { .start =  0x00a0, .end =  0x00ff, .block = zx_latin1_supplement },
